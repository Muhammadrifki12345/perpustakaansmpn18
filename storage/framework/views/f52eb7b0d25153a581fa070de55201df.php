    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 animate-fade-in">
        <div class="flex items-center justify-between mb-10">
            <div>
                ...
                <h2 class="text-4xl font-black text-gray-900 tracking-tight italic uppercase">
                    <?php echo e(auth()->user()->isSuperAdmin() ? 'Manajemen User 👤' : 'Data Siswa 👤'); ?></h2>
            ...
            <a href="<?php echo e(route('users.create')); ?>"
                ...
                Tambah <?php echo e(auth()->user()->isSuperAdmin() ? 'Pengguna' : 'Siswa'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
            <div class="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-black text-gray-900"><?php echo e(\App\Models\User::where('role', 'siswa')->count()); ?>
            ...
            <div
                ...
                <div>
                    ...
                    <p class="text-2xl font-black text-amber-600">
                        <?php echo e(\App\Models\User::where('is_approved', false)->count()); ?></p>
                </div>
            </div>
                ...
                <div class="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-black text-purple-600">
                            <?php echo e(\App\Models\User::where('role', 'admin')->count()); ?></p>
                    </div>
                </div>
            <?php endif; ?>
            <div class="bg-gray-900 p-6 rounded-[2rem] text-white flex items-center gap-4 shadow-xl shadow-gray-200">
                ...
                <div>
                    ...
                    <p class="text-2xl font-black text-white"><?php echo e($users->where('is_active', true)->count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center gap-6 mb-8 border-b border-gray-100 pb-1">
            <a href="<?php echo e(route('users.index')); ?>"
                class="pb-4 text-xs font-black uppercase tracking-widest transition-all <?php echo e((!request('filter') && !request('role')) ? 'text-blue-600 border-b-4 border-blue-600' : 'text-gray-400 hover:text-gray-600 border-b-4 border-transparent'); ?>">
                <?php echo e(auth()->user()->isSuperAdmin() ? 'Semua Pengguna' : 'Anggota Aktif (ACC)'); ?>

            </a>
            <?php if(auth()->user()->isSuperAdmin()): ?>
                <a href="<?php echo e(route('users.index', ['role' => 'admin'])); ?>"
                    class="pb-4 text-xs font-black uppercase tracking-widest transition-all <?php echo e(request('role') === 'admin' ? 'text-purple-600 border-b-4 border-purple-600' : 'text-gray-400 hover:text-gray-600 border-b-4 border-transparent'); ?>">
                    Pengurus (Admin)
                </a>
                <a href="<?php echo e(route('users.index', ['role' => 'superadmin'])); ?>"
                    class="pb-4 text-xs font-black uppercase tracking-widest transition-all <?php echo e(request('role') === 'superadmin' ? 'text-red-600 border-b-4 border-red-600' : 'text-gray-400 hover:text-gray-600 border-b-4 border-transparent'); ?>">
                    Super Admin
                </a>
            <?php endif; ?>
            <a href="<?php echo e(route('users.index', ['filter' => 'pending'])); ?>"
                class="pb-4 text-xs font-black uppercase tracking-widest transition-all <?php echo e(request('filter') === 'pending' ? 'text-amber-500 border-b-4 border-amber-500' : 'text-gray-400 hover:text-gray-600 border-b-4 border-transparent'); ?>">
                Menunggu Persetujuan
                <?php $pendingCount = \App\Models\User::where('role', 'siswa')->where('is_approved', false)->count(); ?>
                <?php if($pendingCount > 0): ?>
                    <span
                        class="ml-2 bg-amber-100 text-amber-600 px-2 py-0.5 rounded-full text-[10px]"><?php echo e($pendingCount); ?></span>
                <?php endif; ?>
            </a>
        </div>
                    ...
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-100">
                            ...
                            <th class="px-6 py-4 text-xs font-black uppercase tracking-wider text-gray-400">
                                <?php echo e(auth()->user()->isSuperAdmin() ? 'Identitas Pengguna' : 'Identitas Siswa'); ?></th>
                            <?php if(auth()->user()->isSuperAdmin()): ?>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div>
                                        <div class="text-sm font-black text-gray-900 italic"><?php echo e($u->name); ?></div>
                                        <div class="text-[10px] text-gray-400 font-bold uppercase tracking-wider">
                                            <?php echo e($u->email); ?></div>
                                    </div>
                                </td>
                                <?php if(auth()->user()->isSuperAdmin()): ?>
                                    <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        ...
                                        <?php echo e($u->kelas ?? ($u->role !== 'siswa' ? 'STAFF' : 'TIDAK ADA')); ?>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <span class="text-xs font-black text-blue-600"><?php echo e($u->loans_count); ?></span>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <?php if(!$u->is_approved): ?>
                                            <form action="<?php echo e(route('users.approve', $u->id)); ?>" method="POST"
                                                class="inline-block">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit"
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="<?php echo e(auth()->user()->isSuperAdmin() ? '7' : '6'); ?>"
...
<?php endif; ?><?php /**PATH C:\Users\H2rtkos\.gemini\antigravity\scratch\perpustakaan-smpn18\resources\views/admin/users/index.blade.php ENDPATH**/ ?>
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-fade-in">
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h2 class="text-3xl font-black text-gray-900 italic uppercase tracking-tight">Edit Penerbit 🏢</h2>
            <p class="text-sm text-gray-500 mt-1 font-medium italic">Memperbarui informasi untuk <span class="text-amber-600">"{{ $penerbit->name }}"</span></p>
        </div>
    ...
    <div class="surface-card">
        <form action="{{ route('penerbit.update', $penerbit->id) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" value="{{ old('name', $penerbit->name) }}" placeholder="Contoh: Gramedia Pustaka Utama..." 
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $penerbit->email) }}" placeholder="penerbit@example.com" 
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone', $penerbit->phone) }}" placeholder="021-xxxxxx" 
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" rows="3" placeholder="Alamat kantor pusat..." 
                              class="w-full rounded-2xl border-gray-100 bg-gray-50 focus:ring-amber-500 font-bold text-sm @error('address') border-red-500 @enderror">{{ old('address', $penerbit->address) }}</textarea>
